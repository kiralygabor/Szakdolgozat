            ...
            <div class="space-y-4 mb-8">
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <span class="text-sm text-gray-600 leading-snug">
                        I agree to the <a href="{{ route('terms') }}" target="_blank" class="text-blue-600 hover:underline">Terms & Conditions</a>, <a href="{{ route('guidelines') }}" target="_blank" class="text-blue-600 hover:underline">Community Guidelines</a>, and <a href="{{ route('privacy') }}" target="_blank" class="text-blue-600 hover:underline">Privacy Policy</a> *
                    </span>
                </label>
