    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl relative mx-4 animate-fade-in-up">
        ...
        <div class="pt-8 pb-6 px-8">
            ...
            <div class="text-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Report Task</h2>
                <p class="text-gray-500 text-sm leading-relaxed">
                    Help us keep Minijobz safe by reporting any suspicious or inappropriate content.
                </p>
            </div>
            ...
            <form id="report-form" method="POST" action="{{ route('reports.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        minlength="10"
                        maxlength="1000"
                        placeholder="Please provide details about why you're reporting this task..."
