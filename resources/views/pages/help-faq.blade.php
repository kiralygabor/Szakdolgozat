...
<div class="min-h-screen bg-gray-50 flex flex-col items-center pt-10 pb-20">
    <div class="w-full max-w-4xl px-6 bg-white py-12 px-8 rounded-xl shadow-sm">
        <h1 class="text-4xl font-bold text-blue-900 mb-8">{{ __('static_pages.faq.title') }}</h1>
       
        <div class="prose max-w-none text-gray-700 space-y-6">
            <p>{{ __('static_pages.faq.intro') }}</p>
           
            <h2 class="text-2xl font-semibold text-blue-800 mt-8 mb-4">{{ __('static_pages.faq.q1') }}</h2>
            <p>{{ __('static_pages.faq.a1') }}</p>
           
            <h2 class="text-2xl font-semibold text-blue-800 mt-8 mb-4">{{ __('static_pages.faq.q2') }}</h2>
            <p>{{ __('static_pages.faq.a2') }}</p>
           
            <h2 class="text-2xl font-semibold text-blue-800 mt-8 mb-4">{{ __('static_pages.faq.q3') }}</h2>
