...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12">
                  <div class="d-flex gap-2 justify-content-between">
                    ...
                    <a href="#!" class="link-primary text-decoration-none"><?php echo e(__('forgot password?')); ?></a>
                  </div>
                </div>
                <div class="col-12">
                  <div class="d-grid my-3">
                    <a href="<?php echo e(route('login.google')); ?>" class="btn btn-danger"> Login with Google</a>
                  </div>
                </div>
                <div class="col-12">
...
</html><?php /**PATH C:\xampp\htdocs\minijobz\resources\views/auth/login.blade.php ENDPATH**/ ?>